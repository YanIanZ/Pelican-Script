...
![Test Panel](https://github.com/YanIanZ/Pelican-Script/actions/workflows/panel.yml/badge.svg)
![Test Wings](https://github.com/YanIanZ/Pelican-Script/actions/workflows/wings.yml/badge.svg)
![Shellcheck](https://github.com/YanIanZ/Pelican-Script/actions/workflows/shellcheck.yml/badge.svg)
[![License: GPL v3](https://img.shields.io/github/license/YanIanZ/Pelican-Script)](LICENSE)
...
```bash
bash <(curl -s https://raw.githubusercontent.com/YanIanZ/Pelican-Script/main/install.sh)
```
